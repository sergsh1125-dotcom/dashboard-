...
for ukr_name, eng_name in region_name_map.items():
    val = region_summary.loc[region_summary["region_name"]==ukr_name, "% забезпечення"]
    coverage_dict[eng_name] = float(val.values[0]) if not val.empty else 0
...
<tr><td style='width:20px;background:#d73027'>&nbsp;</td><td>червоний: <50%</td></tr>
<tr><td style='width:20px;background:#f46d43'>&nbsp;</td><td>помаранчевий: 50–74%</td></tr>
<tr><td style='width:20px;background:#fee08b'>&nbsp;</td><td>жовтий: 75–99%</td></tr>
<tr><td style='width:20px;background:#1a9850'>&nbsp;</td><td>зелений: ≥100%</td></tr>
</table>
</div>
"""
