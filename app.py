...
# =====================================================
# Легенда з видимими кольорами і діапазонами
# =====================================================
legend_html = """
<div style="
position: fixed;
...
padding: 10px;
">
<b>Легенда % забезпечення</b>
<table style='border-collapse: collapse; margin-top:5px;'>
<tr><td style='width:20px;height:20px;background:#d73027;border:1px solid #000'>&nbsp;</td><td style='padding-left:5px'>червоний: <50%</td></tr>
<tr><td style='width:20px;height:20px;background:#f46d43;border:1px solid #000'>&nbsp;</td><td style='padding-left:5px'>помаранчевий: 50–74%</td></tr>
<tr><td style='width:20px;height:20px;background:#fee08b;border:1px solid #000'>&nbsp;</td><td style='padding-left:5px'>жовтий: 75–99%</td></tr>
<tr><td style='width:20px;height:20px;background:#1a9850;border:1px solid #000'>&nbsp;</td><td style='padding-left:5px'>зелений: ≥100%</td></tr>
</table>
</div>
"""
